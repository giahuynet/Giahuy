...
(function () {
    ...
    var wrapper = document.getElementById('main_content'),
        ...
        externalPreview = function (source) {
            ...
            source = '<html><head><meta charset="utf-8"><link rel="shortcut icon" type="image/x-icon"  href="/favicon.ico"><title>Javascript Decryption | Preview</title><style>' + externalStyle + '</style></head><body><pre class="hljs">' + source + '</pre></body></html>';
        ...
        format = debounce(function () {
            ...
            if (!workerFormat) {
                workerFormat = new Worker('/decode/assets/js/worker/format.js');
        ...
        decode = debounce(function () {
            ...
            if (!workerDecode) {
                workerDecode = new Worker('/decode/assets/js/worker/decode.js');
